...
export default function Footer() {
  return (
    <footer className="bg-[#0e2819] text-[#FAF8F4]">
      {/* Main footer */}
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16 xl:px-20 py-16">
      ...
      <div className="border-t border-[#FAF8F4]/5">
        <div className="max-w-[1440px] mx-auto px-8 lg:px-16 xl:px-20 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p
